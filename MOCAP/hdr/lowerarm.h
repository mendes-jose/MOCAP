...
/*!
 * \brief
 * Specifies the representation of an lower arm of the virtual human body model.
 * 
 * \remarks
 * This class is used to represent both left and right lower arms.
 * 
 * \see
 * BodyPart.
 */
...
private:
    ...
    BodyPart *uarm; /**< Specifies a pointer to the body part dependence of this body part */

    /*!
     * \brief
     * See BodyPart::positionUpdate().
     */
    inline virtual void positionUpdate () { this->position = this->uarm->pos()-abs(this->uarm->getDim(2))*this->uarm->O(); }
...
public:
     ...
     */
    Lowerarm ( const unsigned char &iAdapter, const int &DeviceID,
