...
/*!
 * \brief
 * Specifies the representation of an upper arm of the virtual human body model.
 * 
 * \remarks
 * This class is used to represent both left and right upper arms.
 * 
 * \see
 * BodyPart.
 */
...
private:
     ...
     */
    inline virtual void positionUpdate () { this->position = this->thorax->pos() + this->thorax->getDim(2)*this->thorax->O() + this->side*SHOULDERF*this->thorax->getDim(2)*this->thorax->T(); }
