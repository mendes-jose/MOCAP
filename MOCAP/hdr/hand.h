...
/*!
 * \brief
 * Specifies the representation of a hand of the virtual human body model.
 * 
 * \remarks
 * This class is used to represent both left and right hands.
 * 
 * \see
 * BodyPart.
 */
...
private:
    ...
    BodyPart *larm; /**< Specifies a pointer to the body part dependence of this body part */

    /*!
     * \brief
     * See BodyPart::positionUpdate().
     */
    inline virtual void positionUpdate () { this->position = this->larm->pos()-abs(this->larm->getDim(2))*this->larm->O(); }
...
public:
     ...
     */
//    Hand ( const unsigned char &iAdapter, const int &DeviceID,
