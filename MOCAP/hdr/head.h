...
/*!
 * \brief
 * Specifies the representation of the head of the virtual human body model.
 * 
 * \see
 * BodyPart.
 */
...
private:
     ...
     */
    inline virtual void positionUpdate () { this->position = this->thorax->pos() + this->thorax->getDim(2)*this->thorax->O(); }
...
public:
     ...
     */
    Head ( const unsigned char &iAdapter, const int &DeviceID,
