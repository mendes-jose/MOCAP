...
/*!
 * \brief
 * Specifies the representation of a thorax + an abdomen of the virtual human body model.
 * 
 * \remarks
 * This class represents the only body part which doesn't have a body part dependence.
 * If the human body translation is to be implemented, modifying this class to change 
 * its position according to some extra sensor information would be the way to do it.
 * 
 * \see
 * BodyPart.
 */
class Thoraxabdo: public BodyPart
{

private:
    Vector3d light; /**< Specifies the light direction */
    const Vector3d ecc; /**< Specifies the three dimension eccentricity of this body part */
    
    /*!
     * \brief
     * See BodyPart::positionUpdate().
     */
    inline virtual void positionUpdate () {}
