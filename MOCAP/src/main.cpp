...
{
    // Initializations for the box (i.e. srcTrCAN_IO_DLL library) and for the smartphone communication (inits sockets for the TCP server)
    DeviceBox::init();
    DeviceSPh::init();
    ...
    _beginthread( Scene::mainLoop, 0, scene->body );
